...
void
InputManager::BindMouseButtonPressed(MouseButton button, std::string action)
{
  int mouseButton;
  switch (button) {
...
void
InputManager::BindControllerButton(SDL_GameControllerButton button,
                                   std::string action)
{
...
InputManager::HandleEvent(const SDL_Event& event)
{
  switch (event.type) {
    case SDL_CONTROLLERBUTTONDOWN: {
      auto it = m_controllerButtonToAction.find(
