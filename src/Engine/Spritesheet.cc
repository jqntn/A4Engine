...
void
Spritesheet::AddAnimation(std::string name,
...
Spritesheet::GetAnimation(std::size_t animIndex) const
{
  return m_animations[animIndex];
}

std::optional<std::size_t>
Spritesheet::GetAnimationByName(const std::string& animName) const
{
...
std::size_t
Spritesheet::GetAnimationCount() const
{
