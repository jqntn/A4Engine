...
void
SDLppRenderer::DrawLines(const SDL_FPoint* points, std::size_t count)
{
  SDL_RenderDrawLinesF(m_renderer, points, static_cast<int>(count));
}

void
SDLppRenderer::DrawTriangles(const SDL_Vertex* vertices, std::size_t count)
{
  SDL_RenderGeometry(
...
void
SDLppRenderer::DrawTriangles(const SDL_Vertex* vertices,
...
void
SDLppRenderer::DrawTriangles(const SDLppTexture& texture,
...
void
SDLppRenderer::RenderCopy(const SDLppTexture& texture)
{
  SDL_RenderCopy(m_renderer, texture.GetHandle(), nullptr, nullptr);
}

void
SDLppRenderer::RenderCopy(const SDLppTexture& texture, const SDL_Rect& dst)
{
...
void
SDLppRenderer::SetDrawColor(Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
  SDL_SetRenderDrawColor(m_renderer, r, g, b, a);
}

SDLppRenderer&
SDLppRenderer::operator=(SDLppRenderer&& renderer) noexcept
{
