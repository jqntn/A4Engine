...
#include <cmath>
// le #pragma once n'est pas nécessaire ici, un seul fichier va nous inclure
// directement et il est déjà protégé
...
template<typename T>
Vector2<T>
Vector2<T>::Rotate(const Vector2& vec, float degrees)
{
